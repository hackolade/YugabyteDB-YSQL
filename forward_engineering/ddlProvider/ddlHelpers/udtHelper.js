...
const { getNamePrefixedWithSchemaName, wrapComment, commentIfDeactivated } = require('../../utils/general');
const assignTemplates = require('../../utils/assignTemplates');
const templates = require('../templates');

const notPlainTypes = new Set(['composite', 'enum', 'range_udt', 'domain']);
...
const isNotPlainType = definitionJsonSchema => {
	return notPlainTypes.has(definitionJsonSchema.type);
};
